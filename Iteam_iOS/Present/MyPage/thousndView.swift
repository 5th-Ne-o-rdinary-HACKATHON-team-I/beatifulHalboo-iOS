...
class thousndView: UIView {
    ...
    let pinSubLabel = UILabel().then {
       ...
       $0.font = UIFont.caption2
        ...
        attributedStr.addAttribute(.foregroundColor, value: UIColor(hexString: "#FD442B"), range: ($0.text! as NSString).range(of: "100만원"))
        attributedStr.addAttribute(.font, value: UIFont.subTitle1, range: ($0.text! as NSString).range(of: "100만원"))
