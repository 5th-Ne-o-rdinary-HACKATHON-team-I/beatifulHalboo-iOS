...
class thousnd2View: UIView {
    ...
    private let monthEarnPrice = UILabel().then {
        $0.text = "10000000".formatPriceWithWon()
        $0.textColor = .black
        $0.font = UIFont.caption2
        $0.sizeToFit()
    }
    ...
    private let monthSubPrice = UILabel().then {
        $0.text = "3050000".formatPriceWithWon()
        $0.textColor = .black
        $0.font = UIFont.caption2
        $0.sizeToFit()
    }
    private let monthPinPrice = UILabel().then {
        $0.text = "4000000".formatPriceWithWon()
        $0.textColor = .black
        $0.font = UIFont.caption2
        $0.sizeToFit()
    }
    ...
    private let lastPrice = UILabel().then {
        $0.text = "240000".formatPriceWithWon()
        $0.textColor = .darkGray
        $0.font = UIFont.caption2
        $0.sizeToFit()
    }
